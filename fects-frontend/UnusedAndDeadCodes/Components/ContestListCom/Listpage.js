...
//           </span>
//         ))}
//         <span className="flex items-center p-2 flex gap-2">
...
//   const tableHead = ["Image", "Contest Name", "Contest Description", "Organised By", "Start Date", "Finish Date", "Actions"];
...
//         .get(`${Backend_Server_URL}/v1/api/contest/`)
//         .then((response) => {
//           const data = response.data;
//           setContestData(data);
//         });
//     } catch (err) {
//       console.log("Error in Fetch Contest Data", err);
//     }
//   };
...
//     try {
//       const deleteData = await axios.delete(`http://localhost:8080/v1/api/contest/${id}`)
//       setContestData(contestData.filter(item => item.id !== id))
//     } catch (err) {
...
//     if (text) {
//       const search = await fetch(`http://localhost:8080/v1/api/contest/search/${text}`);
//       const searchdata = await search.json();
//       console.log("Search Data ", searchdata)
//       if (searchdata) {
//         setContestData(searchdata);
//       }
//     } else {
//       FetchContestData();
//     }
...
//         <Link href="/admin/contest/0" className="text-sm font-medium leading-none text-white">Create Contest</Link>
//       </button>
//     </div>
//   </div>
...
//           </svg>
//         </div>
//         <input onChange={HandleSearch} type="text" id="simple-search" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required="" />
//       </div>
//     </div>
//   </div>
...
//         <thead>
//           <tr className="h-16 border-b border-gray-200 bg-gray-50">
...
//               </td>
//               <td className="px-4 py-2 whitespace-nowrap">
//                 <div className="text-sm text-gray-500">{item.startDate}</div>
//               </td>
//               <td className="px-4 py-2 whitespace-nowrap">
//                 <div className="text-sm text-gray-500">{item.finishDate}</div>
//               </td>
...
//                   </button>
//                 </Link>
//                 <button onClick={() => HandleDelete(item.id)} className="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 flex item-center">
