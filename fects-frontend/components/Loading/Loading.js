export const ImageLoading = () => {
    return (
        <div className="w-full mb-2.5 break-inside-avoid bg-gray-300 rounded-md h-60 animate-shimmer"></div>
    )
}

export const ImageLoading1 = () => {
    return (
        <div class='flex space-x-2 justify-center items-center bg-white h-60 m-1 dark:invert'>
